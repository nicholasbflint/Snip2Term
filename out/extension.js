...
function activate(context) {
    ...
    // Search snippets
    context.subscriptions.push(vscode.commands.registerCommand('snip2term.search', async () => {
    ...
    // Clear search
    context.subscriptions.push(vscode.commands.registerCommand('snip2term.clearSearch', () => {
